...
public class EqualsBuilder {
    ...
    static boolean isRegistered(final Object lhs, final Object rhs) {
        ...
        final Pair<IDKey, IDKey> swappedPair = new Pair<>(pair.first, pair.second);
    ...
    public static boolean reflectionEquals(final Object lhs, final Object rhs, final Collection<String> excludeFields) {
        String[] fieldArray;
        if (null == excludeFields || excludeFields.size() == 0) {
            fieldArray = new String[0];
        } else {
            fieldArray = new String[excludeFields.size()];
            excludeFields.toArray(fieldArray);
        }

        return reflectionEquals(lhs, rhs, fieldArray);
    }
