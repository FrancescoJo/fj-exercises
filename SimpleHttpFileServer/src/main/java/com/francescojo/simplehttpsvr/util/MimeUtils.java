...
public final class MimeUtils {
    ...
    static {
        ...
        add("application/x-font-ttc", "ttc");
        add("application/x-font-ttf", "ttf");
        add("application/x-font-opentype", "otf");
        ...
        add("application/x-redhat-package", "rpm");
