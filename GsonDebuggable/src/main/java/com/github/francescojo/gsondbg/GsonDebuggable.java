...
public class GsonDebuggable {
	private static final boolean IS_DEBUG = true;
	private final static Logger LOGGER = Logger.getLogger(GsonDebuggable.class.getName());

	private static Callable<GsonDebuggable> instanceFactory = null;
	 ...
	 */
	protected static void setInstanceFactory(Callable<GsonDebuggable> instanceFactory) {
		GsonDebuggable.instanceFactory = instanceFactory;
	}
	 ...
	 */
	public static GsonDebuggable getInstance() {
	...
	private static class InstanceHolder {
		private static final GsonDebuggable INSTANCE = new GsonDebuggable();
	}
	...
	/**
	 * See {@link com.google.gson.Gson#newJsonWriter(Writer)} for its original documentation.
	 * <p>
	 * FIXME: This method is introduced in Gson 2.4. Safe to delete if your Gson is lower than 2.4.
	 * </p>
	 */
	...
	/**
	 * See {@link com.google.gson.Gson#newJsonReader(Reader)} for its original documentation.
	 * <p>
	 * FIXME: This method is introduced in Gson 2.6. Safe to delete if your Gson is lower than 2.6.
	 * </p>
	 */
